...
# sns.barplot(x="mnth_desc", y=["casual", "registered"], data=sum_order_items_df, kind="bar", ax=ax[1], color=["#72BCD4", "#FFA07A"])
...
with col1:
    ...
    # Recency hanya ada di dataframe rfm_df, bukan di rfm_df.
    # Gantilah rfm_df.recency.mean() dengan rfm_df.recency.mean():
